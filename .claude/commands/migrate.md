...
2. Run `cd backend && .venv/bin/alembic revision --autogenerate -m "$ARGUMENTS"` where $ARGUMENTS is the migration description provided by the user (default: "auto migration" if none given).
